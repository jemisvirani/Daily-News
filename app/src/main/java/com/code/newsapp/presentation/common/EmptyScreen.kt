...
fun EmptyScreen(error: LoadState.Error? = null) {
    ...
    EmptyContent(alphaAnim = alphaAnimation.value, message = message, iconId = icon)
}
...
fun ShimmerEffectPreview() {
    EmptyContent(alphaAnim = 0.3f, message = "Internet Unavailable.", iconId = R.drawable.ic_logo)
}
