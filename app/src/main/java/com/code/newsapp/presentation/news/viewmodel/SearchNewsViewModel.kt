...
class SearchNewsViewModel(@ApplicationContext val context: Context, val searchRepository: NewsSearchRepository,
) : ViewModel() {
    ...
    private val _bookMarkData = MutableStateFlow<List<Article?>>(emptyList())
    val bookMarkData: StateFlow<List<Article?>> = _bookMarkData
